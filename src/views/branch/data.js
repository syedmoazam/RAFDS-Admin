                ...
                <div className='d-flex'>
                    <UncontrolledDropdown>
                        ...
                        <DropdownMenu right>
                            ...
                            <DropdownItem>
                                <Archive size={15}/>
                                <Link to={`/branch/inventory/${row._id}`}>
                                    <span className='align-middle ml-50'>View Inventory</span>
                                </Link>
                            </DropdownItem>
                            <DropdownItem>
                                <BookOpen size={15}/>
                                <Link to={`/branch/requests/${row._id}`}>
...
export const branchInventoryRequestsColumns = [
    ...
    },
    {
        ...
        selector: 'witnessName1',
        sortable: true,
        maxWidth: '350px'
    },
    {
        name: 'CNIC of Witness 1',
        selector: 'witnessCNIC1',
        sortable: true,
        maxWidth: '350px'
    },
    {
        name: 'Name of Witness 2',
        selector: 'witnessName2',
        sortable: true,
        maxWidth: '350px'
    },
    {
        name: 'CNIC of Witness 2',
        selector: 'witnessCNIC2',
        sortable: true,
        maxWidth: '350px'
    },
    {
        ...
        cell: row => {
            return (
                <Badge color={status[row.status.toLowerCase()].color} pill>
                    {status[row.status.toLowerCase()].title}
                </Badge>
            )
        }
    },
                ...
                <div className='d-flex justify-content-center'>
                    <UncontrolledDropdown>
                        ...
                        <DropdownMenu right>
                            <DropdownItem>
                                <Archive size={15}/>
                                <span onClick={() => row.cb(row)} className='align-middle ml-50'>View Inventory</span>
                            </DropdownItem>
                        </DropdownMenu>
                    </UncontrolledDropdown>
                </div>
